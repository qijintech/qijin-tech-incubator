...
mvn -Dmybatis.generator.overwrite=true mybatis-generator:generate -pl chat-db/

echo "开始生成Dao文件"

pack=tech.qijin.chat
artifactId=chat
...
mapper_path=chat-db/src/main/java/$pack_path/db/mapper
dao_path=chat-db/src/main/java/$pack_path/db/dao
model_path=chat-db/src/main/java/$pack_path/db/model
