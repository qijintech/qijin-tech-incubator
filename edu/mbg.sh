...
mvn -Dmybatis.generator.overwrite=true mybatis-generator:generate -pl edu-db/
...
mapper_path=edu-db/src/main/java/$pack_path/db/mapper
dao_path=edu-db/src/main/java/$pack_path/db/dao
model_path=edu-db/src/main/java/$pack_path/db/model
