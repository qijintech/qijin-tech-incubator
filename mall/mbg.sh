...
mvn -Dmybatis.generator.overwrite=true mybatis-generator:generate -pl mall-db/
...
mapper_path=mall-db/src/main/java/$pack_path/db/mapper
dao_path=mall-db/src/main/java/$pack_path/db/dao
