...
mvn -Dmybatis.generator.overwrite=true mybatis-generator:generate -pl satellites-db/

echo "开始生成Dao文件"

pack=tech.qijin.satellites
artifactId=satellites
...
mapper_path=satellites-db/src/main/java/$pack_path/db/mapper
dao_path=satellites-db/src/main/java/$pack_path/db/dao
