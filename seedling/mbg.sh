...
mvn -Dmybatis.generator.overwrite=true mybatis-generator:generate -pl seedling-db/

echo "开始生成Dao文件"

pack=tech.qijin.seedling
artifactId=seedling
...
mapper_path=seedling-db/src/main/java/$pack_path/db/mapper
dao_path=seedling-db/src/main/java/$pack_path/db/dao
model_path=seedling-db/src/main/java/$pack_path/db/model
