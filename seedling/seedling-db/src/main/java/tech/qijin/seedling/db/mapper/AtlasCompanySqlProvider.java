...
import tech.qijin.seedling.db.model.AtlasCompanyExample.Criteria;
import tech.qijin.seedling.db.model.AtlasCompanyExample.Criterion;
import tech.qijin.seedling.db.model.AtlasCompanyExample;

public class AtlasCompanySqlProvider {

    public String countByExample(AtlasCompanyExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("atlas_company");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(AtlasCompanyExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("atlas_company");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(AtlasCompany record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("atlas_company");
        
        if (record.getBrandName() != null) {
            sql.VALUES("brand_name", "#{brandName,jdbcType=VARCHAR}");
        }
        
        if (record.getPopularName() != null) {
            sql.VALUES("popular_name", "#{popularName,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(AtlasCompanyExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AtlasCompany record = (AtlasCompany) parameter.get("record");
        AtlasCompanyExample example = (AtlasCompanyExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("atlas_company");
        ...
        if (record.getPopularName() != null) {
            sql.SET("popular_name = #{record.popularName,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(AtlasCompany record) {
        SQL sql = new SQL();
        sql.UPDATE("atlas_company");
        ...
        if (record.getPopularName() != null) {
            sql.SET("popular_name = #{popularName,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(SQL sql, AtlasCompanyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
