...
mvn -Dmybatis.generator.overwrite=true mybatis-generator:generate -pl usercenter-db/

echo "开始生成Dao文件"

pack=tech.qijin.usercenter
...
mapper_path=usercenter-db/src/main/java/$pack_path/db/mapper
dao_path=usercenter-db/src/main/java/$pack_path/db/dao
